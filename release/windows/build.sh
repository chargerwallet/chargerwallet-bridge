...
build_package() {
    ...
    cp ./chargerwalletd.nsis ./target/installer/
    cp ./chargerwalletd.ico ./target/installer/
    cp ./output/devcon_*.exe ./target/installer/
    cp ./output/wdi-simple_*.exe ./target/installer/
    cp ./input_files/chargerwalletd_windows_*.exe ./target/installer/
    cd ./target/installer/
    makensis -D"BuildVersion=$VERSION" chargerwalletd.nsis
    mv chargerwallet-bridge-$VERSION-install.exe ../../output/
    cd ../../
}
