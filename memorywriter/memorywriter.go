...
func (m *MemoryWriter) Log(s string) {
	...
	function = strings.TrimPrefix(function, "github.com/chargerwallet/chargerwallet-bridge/")
...
// In our case, additional text is devcon exports and chargerwallet version
