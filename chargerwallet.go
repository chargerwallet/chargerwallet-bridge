...
import (
	...
	"github.com/chargerwallet/chargerwallet-bridge/server"
	"github.com/chargerwallet/chargerwallet-bridge/usb"
...
func main() {
	...
	flag.Var(&ports, "e", "Use UDP port for emulator. Can be repeated for more ports. Example: chargerwallet-go -e 21324 -e 21326")
	flag.Var(&touples, "ed", "Use UDP port for emulator with debug link. Can be repeated for more ports. Example: chargerwallet-go -ed 21324:21326")
	flag.BoolVar(&withusb, "u", true, "Use USB devices. Can be disabled for testing environments. Example: chargerwallet-go -e 21324 -u=false")
	...
	if versionFlag {
		fmt.Printf("chargerwallet version %s", version)
		return
	}
	...
	stderrLogger.Printf("chargerwallet v%s is starting.", version)
