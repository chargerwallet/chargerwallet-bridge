...
import (
	...
	"github.com/chargerwallet/chargerwallet-bridge/wire"
)
...
const (
	...
	VendorChargerWallet        = 0x1209
	ChargerWalletBootloader    = 0x4F4A
	ChargerWalletirmware       = 0x4F4B
)
...
// Chrome tries to read from chargerwallet immediately after connecting,
