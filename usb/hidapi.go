...
import (
	...
	lowlevel "github.com/chargerwallet/chargerwallet-bridge/usb/lowlevel/hidapi"
...
func (b *HIDAPI) match(d *lowlevel.HidDeviceInfo) bool {
	...
	return (trezor1 || trezor2 || chargerwallet) && (d.Interface == int(normalIface.number) || d.UsagePage == hidUsagePage)
}
