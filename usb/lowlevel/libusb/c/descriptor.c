 ...
 * function always succeeds. (Not true in chargerwallet fork on windows.)
 *
	...
	struct libusb_device_descriptor *desc)
{
	...
	#ifdef OS_WINDOWS
	// hack for filtering out non-winusb devices in chargerwallet
	// (note that in ChargerWallet layer, throwing error here does NOT throw error up the chain,
